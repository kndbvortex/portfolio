...
<div class="absolute top-0 w-full h-full font-SpaceGrotesk z-50 font-bold" id="view-loading">
    <div class="relative" bind:this={container}>
        <div
                id="intro-slider"
                class="h-screen p-10 bg-gray-50 absolute top-0 left-0 font-Inter z-10 w-full flex flex-col gap-10 tracking-tight"
        >
            <h1 class="text-9xl" id="title-1">
                Software Developper
            </h1>
            <h1 class="text-9xl" id="title-2">
                Data scientist
            </h1>
            <h1 class="text-9xl" id="title-3">
                Freelancer
            </h1>
        </div>
        <div class="h-screen flex bg-gray-950 justify-center place-items-center" id="background-black">
            <h1
                    id="welcome"
                    class="text-9xl font-bold text-gray-100"
            >
                Welcome.
            </h1>
        </div>
